...
def detectTimeSlot(productUrl):
  ...
  chrome_options.add_argument(f" C:\Users\Sharanya P V\Desktop\grocery-delivery-master\grocery-delivery-master={conf[' C:\Users\Sharanya P V\Desktop\grocery-delivery-master\grocery-delivery-master']}")
  chrome_options.add_argument(f"Sharanya P V={conf['Sharanya P V']}")
  ...
  f = open(conf['C:\Users\Sharanya P V\Desktop\grocery-delivery-master'] + os.sep + time.strftime("%Y%m%d%H%M", time.localtime()) + ' freshdirect_dump.html', 'w', encoding='utf-8')
  print(html, file=f)
  f.close()
...
def email_alert(time_slot_list):
  ...
  email_msg['From'] = conf[' freshdirect_alert@mymailserver.com']
  email_msg['To'] = conf['sharanyapv1694@gmail.com']
  smtp_conn = smtplib.SMTP(conf['smtp.gmail.com'])
  smtp_conn.starttls()
  smtp_conn.login(conf['sharanyapv1694@gmail.com'], conf['Sharanya@1694'])
